---
name: finance-landed-cost-unit-economics
description: Rebuild a SKU's full cost chain from ex-works factory price to refunded customer into an executable unit-economics model — a fully-loaded landed-cost waterfall (product / tooling amortization / first-mile freight / duty / brokerage-MPF-HMF / 3PL + FBA inbound, US Section 301 vs EU import-VAT+IOSS kept strictly separate), a CM1/CM2/CM3 contribution-margin waterfall with the full Amazon 2026 fee stack and return shrinkage, a break-even dashboard (break-even ROAS = 1/CM%, ACoS ceiling, break-even price, FX sensitivity), a five-scenario sensitivity panel (tariff / return rate / fee hike / FX / price increase), and a keep / kill / reprice action list ranked by CM3. Use when the user wants to know whether a SKU actually makes money after every real cost is loaded in, before scaling ads or greenlighting a new product. Triggers on "landed cost", "unit economics", "CM1 CM2 CM3", "break-even ROAS", "ACoS ceiling", "algo landed cost for this SKU", "is this SKU actually profitable", "keep or kill this SKU", "算落地成本", "单位经济", "这个 SKU 到底赚不赚钱", "贡献毛利", "保本 ROAS", "保本售价", "关税涨了还赚不赚", "选品财务测算", "广告能烧到多少". Pairs with /finance-pricing-margin-guard (consumes CM% as its pricing floor), /finance-reconciliation-bookkeeping (supplies the reconciled fee facts this model should sit on), /finance-tax-nexus-vat-diagnostic (tax-drag inputs), /finance-cashflow-runway-forecaster (per-unit cash contribution), /amazon-product-selection (financial gate on selection) and /dsite-sem-ads (ACoS ceiling for bidding).
---
